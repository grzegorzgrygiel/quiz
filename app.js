...
const quiz = document.querySelector("#quizQuestion");
...
function addNewQuestion(id, questionData) {
    ...
    q.append(`Q${id + 1}. `); // nie wyświetlają się numery pytań
    q.innerHTML = `${questionData.question}`; // innerHTML tworzy html wewnątrz elementu
    quiz.append(q);
